...
namespace BraintreeUIKit
{
	...
	interface BTUIKLocalizedString
	{
		...
		void SetCustomTranslations(NSObject[] locales);
	...
	interface BTUIKCardType
	{
		...
		// @property (readonly, nonatomic, strong) NSArray * relaxedPrefixes;
	...
	{
		// @property (readonly, nonatomic, strong) NSString * cardholderName;
	...
	interface BTUIKAppearance
	{
		...
		// @property (readonly, nonatomic, strong) UIFont * boldFont;
		...
		// @property (readonly, getter = highlightedTintColor, nonatomic) UIColor * highlightedTintColor;
		[Export("highlightedTintColor")]
		UIColor HighlightedTintColor { [Bind("highlightedTintColor")] get; }
